    ...
    <main className="container-page py-16">
      ...
      <section className="mt-12 grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <CategoryCard
          ...
          cta="Daftar Prestasi"
          illustration={categoryImages.prestasi || "https://ltmfvbcazebowndigkyi.supabase.co/storage/v1/object/public/admin-media/branding/jalur-prestasi.jpg?t=1723334400123"}
        />
        <CategoryCard
          to="/beasiswa-ekonomi"
          ...
          cta="Daftar Ekonomi"
          illustration={categoryImages.ekonomi || "https://ltmfvbcazebowndigkyi.supabase.co/storage/v1/object/public/admin-media/branding/jalur-ekonomi.jpg?t=1723334400123"}
        />
        <CategoryCard
          to="/beasiswa-umum"
          icon={<Users size={20} />}
          ...
          cta="Daftar Umum"
          illustration={categoryImages.umum || "https://ltmfvbcazebowndigkyi.supabase.co/storage/v1/object/public/admin-media/branding/jalur-umum.jpg?t=1723334400123"}
        />
        <CategoryCard
          to="/beasiswa-yatim"
          icon={<Heart size={20} />}
          ...
          cta="Daftar Yatim"
          illustration={categoryImages.yatim || "https://ltmfvbcazebowndigkyi.supabase.co/storage/v1/object/public/admin-media/branding/jalur-yatim.jpg?t=1723334400123"}
        />
      </section>
    </main>
  );
