-- Update timeline in site_settings to ensure Registration, Poster, and Berkas all end on Feb 7
...
-- Update countdown to Feb 7, 2027
UPDATE public.site_settings
SET value = '{"targetDate": "2027-02-07T23:59:59", "label": "Pendaftaran Berakhir Dalam"}'::jsonb
WHERE key = 'countdown';
